...
| :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| **Within-Session Subject-Dependent** | [train.py](file:///c:/Dev/BCI/DBGC-ATFFNet-AFTL/train.py) | Single Session (S1) | Trials 1-9 for training;<br>Trials 10-15 for testing | Window-level | 200 | **96.46%** | **86.63%**<br>(Std: 8.38%) |
| **Cross-Session LOSO with Voting** | [train_loso.py](file:///c:/Dev/BCI/DBGC-ATFFNet-AFTL/train_loso.py) | Cross-Session (S1-S3) | 3-Fold Leave-One-Session-Out | Window-level /<br>Trial-level (Voting) | 10 | **82.22%**<br>(Voting) | **70.96%**<br>(Voting) |
| **Within-Session 5-Fold CV** | [train_5fold.py](file:///c:/Dev/BCI/DBGC-ATFFNet-AFTL/train_5fold.py) | Single Session (S1) | Randomly shuffle and split all windows 8:2 | Window-level | 30 | **100.00%** | **100.00%**<br>(Std: 0.00%) |
| **Adapter-Finetuned Transfer (AFTL)** | [train_aftl.py](file:///c:/Dev/BCI/DBGC-ATFFNet-AFTL/train_aftl.py) | Cross-Subject (S1) | Pretrain on 14 source subjects;<br>Fine-tune on 50% target subject | **Window-level (Shuffle)**<br><hr>**Trial-level (No Leakage)** | Pretrain: 30<br>Finetune: 50 | **94.40%** (bs=256)<br>**100.00%** (bs=128)<br><hr>**61.28%** (Best @ Ep1)<br>**26.22%** (Final @ Ep50) | **94.39%** (Paper)<br><hr>**N/A** (Overfitted) |
