...
| **Cross-Session LOSO with Voting** | [train_loso.py](file:///c:/Dev/BCI/DBGC-ATFFNet-AFTL/train_loso.py) | Cross-Session (S1-S3) | 3-Fold Leave-One-Session-Out | Window-level /<br>Trial-level (Voting) | 10 | **60.00%** (Voting)<br>**57.56%** (Window)<br>*(82.22% Voting @ 200ep)* | **70.96%** (Voting)<br>**67.75%** (Window) |
