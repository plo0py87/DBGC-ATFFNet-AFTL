...
| **Cross-Session LOSO with Voting** | [train_loso.py](file:///c:/Dev/BCI/DBGC-ATFFNet-AFTL/train_loso.py) | Cross-Session (S1-S3) | 3-Fold Leave-One-Session-Out | Window-level /<br>Trial-level (Voting) | 200 | **82.22%** (Voting)<br>*(at 200 epochs)* | **N/A**<br>*(Pending 200ep run)* |
